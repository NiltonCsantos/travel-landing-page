  ...
  return (
    <div className="cover">
      <div className="main-content">
        <h1>
          <span>Descubra</span> onde <br />a vida pulsa <GiCommercialAirplane />{" "}
          <br /> com <span>intensidade</span>
        </h1>

        <p>
          Descubra onde a vida ganha intensidade. <br /> Viaje e viva momentos
          únicos
        </p>
        ...
        <ul>
          ...
          <li>
            <BsPersonVcard className="icon" /> 5000+
            <br />
            <span>Passageiros satisfeitos</span>
          </li>
        </ul>
      </div>
